...
} from '../../../../validator/app/auth.validator';
...
class AuthController {
  ...
  public static completeRegister = async (
    req: Request,
    res: Response,
    next: NextFunction,
  ) => {
    try {
      ...
      if (
        !userObj.expiredAt ||
        currentTime > new Date(userObj.expiredAt).getTime()
      ) {
        next({
          status: 400,
  ...
  public static reqResetPassword = async (
    req: Request,
    res: Response,
    next: NextFunction,
  ) => {
    try {
      ...
      await SMTPService.sendAppOTPPasswordReset(
        value.email,
        user.username,
        newOtp,
      );
  ...
  public static confirmResetPassword = async (
    req: Request,
    res: Response,
    next: NextFunction,
  ) => {
  ...
  public static checkRefreshToken = async (
    req: Request,
    res: Response,
    next: NextFunction,
  ) => {
